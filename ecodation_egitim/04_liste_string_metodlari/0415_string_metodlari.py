...
# region ornek2
"""
result="Ecodation,Yazılım,ve,Eğitim,Kurumu"
if "Yaz" in result:
    print(result.index("Yaz"))
print(result.find("Yez"))
if not result.find("Yez")==-1:
    print(result.find("Yez"))
print(result.split(","))
dizin="c:\program files\sistem\driver\win32"
result = dizin.split("\\")
print(dizin.split("\\"))
for i in result:
    print(i)
x = isinstance("ecodation", str)
print(x))
"""
# endregion